title=Pixi
tags=tool, build, python
summary=A fast, modern, and reproducible package management tool for developers of all backgrounds.
~~~~~~

[Website](https://pixi.prefix.dev/latest/) | [Source](https://github.com/prefix-dev/pixi)
