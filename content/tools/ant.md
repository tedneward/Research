title=Ant
tags=tool, jvm, build
summary=A Java library and command-line tool whose mission is to drive processes described in build files as targets and extension points dependent upon each other. 
~~~~~~

[Website](http://ant.apache.org/) | [Source](http://ant.apache.org/git.html)
