title=Language Model Training (How-Tos)
tags=ai, llm, slm, training, fine-tuning, inference engine
summary=Training and fine-tuning language models.
~~~~~~
...
* [Train your own language model with nanoGPT](https://sophiamyang.medium.com/train-your-own-language-model-with-nanogpt-83d86f26705e)

* [How to Train an LLM on Your Own Data: Beginner’s Guide](https://www.heavybit.com/library/article/train-LLM-on-own-data)
