...
tags=ai, agent, harness, skill
summary=A collection of links to different agent SKILL.md files/collections.
~~~~~~

I fully expect that before long, skills will be associated with their company/provider, rather than gathered here, much like documentation. (In other words, skills just become part of the product/offering's "table stakes" provided to developers.)
...
- [awesome-copilot](https://github.com/github/awesome-copilot): Community-contributed instructions, agents, skills, and configurations to help you make the most of GitHub Copilot.
