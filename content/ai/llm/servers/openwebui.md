...
[Website](https://openwebui.com/) | [Source](https://github.com/open-webui/open-webui) | [Docs](https://docs.openwebui.com/features)

## Key Features of Open WebUI ⭐

- Install using Docker or Kubernetes (kubectl, kustomize or helm) with support for both `:ollama` and `:cuda` tagged images.

- Ollama/OpenAI API Integration: Integrate OpenAI-compatible APIs for conversations alongside Ollama models. Customize the OpenAI API URL to link with LMStudio, GroqCloud, Mistral, OpenRouter, and more.
...
Open WebUI can be installed using using **Python 3.11**.
