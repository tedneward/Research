...
summary=An AI compute engine that consists of a core distributed runtime and a set of AI Libraries for accelerating ML workloads.
~~~~~~

[Website](https://www.ray.io/) | [Source](https://github.com/ray-project/ray) | [Tutorial](https://github.com/dmatrix/ray-core-tutorial)

Ray is a unified framework for scaling AI and Python applications. Ray consists of a core distributed runtime and a set of AI libraries for simplifying ML compute:

[![](https://github.com/ray-project/ray/raw/master/doc/source/images/what-is-ray-padded.svg)](https://github.com/ray-project/ray/raw/master/doc/source/images/what-is-ray-padded.svg)
...
Ray runs on any machine, cluster, cloud provider, and Kubernetes, and features a growing [ecosystem of community integrations](https://docs.ray.io/en/latest/ray-overview/ray-libraries.html).
