...
summary=OpenAPI for agents: a single, declarative spec that says what an agent is, what tools it can call, what data it can touch, and how it is configured.
~~~~~~

[Source](https://github.com/nextmoca/adl)
