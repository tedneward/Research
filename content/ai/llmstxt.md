title=llms.txt (Website convention)
tags=ai, specification, convention
summary=A proposal to standardise on using an /llms.txt file to provide information to help LLMs use a website at inference time.
~~~~~~

[Website](https://llmstxt.org/) | [Source](https://github.com/answerdotai/llms-txt)
