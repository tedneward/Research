...
summary=A powerful new web framework for creating modern, dynamic, frontend applications without JavaScript, that can be fully scripted and controlled by backend code.
~~~~~~
[Website](https://hibikihtml.com/) | [GitHub](https://github.com/dashborg/hibiki) | [Tutorial](https://playground.hibikihtml.com/tutorial/) | [Playground](https://playground.hibikihtml.com/) | [Docs](https://docs.hibikihtml.com/)
---
## Getting Started
