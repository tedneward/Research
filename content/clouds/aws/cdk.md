title=Amazon Cloud Development Kit (CDK)
tags=cloud, aws
summary=An open-source software development framework for defining cloud infrastructure in code and provisioning it through AWS CloudFormation.
~~~~~~

[Website](https://docs.aws.amazon.com/cdk/) | [API Reference](https://docs.aws.amazon.com/cdk/api/latest/docs/aws-construct-library.html) | [Dev Guide (PDF)](https://docs.aws.amazon.com/cdk/v2/guide/awscdk.pdf) | [Examples](https://github.com/aws-samples/aws-cdk-examples)
