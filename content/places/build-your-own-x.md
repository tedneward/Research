...
tags=place, presentation, storage, language, vm, gamedev
summary=A collection of links on how to build various things as a learning exercise.
~~~~~~

[Build-your-own](https://build-your-own.org/): Looks to be a singly-managed website inspired by the Github Page Website below

* [... Redis with C/C++](https://build-your-own.org/redis/)
* [... Database](https://build-your-own.org/database/)
* [... Compiler](https://build-your-own.org/compiler/)

---

[Github Page Website](https://github.com/danistefanovic/build-your-own-x)

(Contents copied on 7/1/2023 for convenience)
