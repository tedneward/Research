title=macOS (OS) Development
tags=platform, macos
summary=Writing code for the Apple operating system (on top of the open-source Darwin kernel) that ships with Apple desktop computers.
~~~~~~
...
#### [NSImage Syntax](https://hetima.github.io/fucking_nsimage_syntax/)
