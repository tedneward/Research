...
The CLR platform. [Specifications](clr/specifications)
...
There used to be multiple CLR implementations, but all have more or less fallen into disuse and disrepair. [.NET Core (CoreCLR)](clr/dotnetcore) and the Windows CLR are the only ones left standing.

[CLR Interoperability](clr/interoperability)
