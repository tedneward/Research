title=Decker
tags=platform, presentation, tool, language, browser
summary=A multimedia platform for creating and sharing interactive documents, with sound, images, hypertext, and scripted behavior.
~~~~~~

[Website](https://beyondloom.com/decker/) | [Source](https://github.com/JohnEarnest/Decker)
...
The Basics
==========
Decker organizes information on _Cards_. Think of them like a paper index card you can draw on. A collection of these cards is called a _Deck_. Each card contains different information, organized however you like. You see the topmost card in the deck, and you can flip to a different card at any time. Decker cards can have _Widgets_; interactive elements like buttons.
