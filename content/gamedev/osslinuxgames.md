...
tags=gamedev
summary=A collection of open-source games; capturing them here for play and research purposes.
~~~~~~



* [Astromenace](https://viewizard.com/) ([Source](https://github.com/viewizard/astromenace)): Hardcore 3D space scroll-shooter with spaceship upgrade possibilities.
...
* [Jumblie](https://jumblie.com/) ([Source](https://github.com/cassidoo/jumblie)): A jumbled word search game.
...
* [Teeworlds](https://www.teeworlds.com/) ([Source](https://github.com/teeworlds/teeworlds)): A retro multiplayer shooter.
...
* [Unvanquished](https://unvanquished.net/) ([Source](https://github.com/Unvanquished/Unvanquished)): An FPS/RTS hybrid game powered by the Daemon engine (a combination of ioq3 and XreaL).
...
* [World of PADMAN](https://worldofpadman.net/) ([Source](https://github.com/PadWorld-Entertainment/worldofpadman)): World of PADMAN is an incredibly carefully designed and colorful freeware fun shooter for young and young-at-heart people, created by cartoonist and illustrator ENTE and the WoP team, aka. PadWorld Entertainment.
