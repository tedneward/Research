...
tags=hardware
summary=PCs, mini-PCs, gaming rigs, etc
~~~~~~

## Desktops

- [Skytech Gaming](https://skytechgaming.com/custom-pc-builder/)
- [ThermalTake](https://thermaltakeusa.com/)
...
- [Forget the Mac mini M4: If I could only have one mini PC, this pocketable powerhouse is the one I’d get](https://www.tomsguide.com/computing/mini-pcs/khadas-mind-2s-review)
- [I served a 200 billion parameter LLM from a Lenovo workstation the size of a Mac Mini](https://www.xda-developers.com/lenovo-thinkstation-pgx-review/)
