...
tags=library, language, concurrency, crdt
summary=CRDTs on different replicas can diverge from one another but at the end they can be safely merged providing an eventually consistent value. In other words, CRDTs have a merge method that is idempotent, commutative and associative.
~~~~~~
...
- Rust: [rust-crdt](https://github.com/rust-crdt/rust-crdt)
