title=Parsix
tags=library, jvm, language, reading
summary=High level parsing to ensure input is in the right shape and satisfies all constraints that business logic requires.
~~~~~~

[Source](https://github.com/parsix/parsix)

It is highly inspired by the work of Alexis King ["Parse, don't validate"](https://lexi-lambda.github.io/blog/2019/11/05/parse-don-t-validate/), we recommend reading it even if you are unfamiliar with Haskell. We have also published a new article specific to Kotlin: [Parse, don't validate in Kotlin](https://pelligra-s.medium.com/parse-dont-validate-in-kotlin-afbac505a04f)
