...
[Website](https://www.postgresql.org/) | [Source](https://git.postgresql.org/gitweb/?p=postgresql.git) | [Wiki](https://wiki.postgresql.org/wiki/Main_Page)
...
* API: [PostgREST](https://github.com/PostgREST/postgrest)
...
* [PostgREST](https://github.com/PostgREST/postgrest) - Serves a fully RESTful API from any existing PostgreSQL database. [Docs](https://docs.postgrest.org/en/v13/index.html)
