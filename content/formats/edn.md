...
tags=format, distribution, jvm
summary=A format for serializing data.
~~~~~~

[Spec](https://github.com/edn-format/edn) | [Implementations](https://github.com/edn-format/edn/wiki/Implementations) | [Tagged Elements](http://www.compoundtheory.com/clojure-edn-walkthrough/)


## [Learn X in Y minutes Quick Intro](https://learnxinyminutes.com/docs/edn/)
