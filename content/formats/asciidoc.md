title=ASCIIdoc
tags=format
summary=An authoring language for documentation that leverages "just" ASCII characters.
~~~~~~

[Website](http://asciidoc.org/) (original Python implementation); [asciidoctor](http://asciidoctor.org/) (alternative Ruby implementation site)
