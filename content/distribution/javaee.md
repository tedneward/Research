title=JavaEE (Enterprise Edition)
tags=distribution, specification
summary=A collection of specifications and implementations for the JavaEE platform.
~~~~~~
...
## Java EE 5: [JSR 244](https://jcp.org/en/jsr/detail?id=244)
...
## Java EE 6: [JSR 316](https://jcp.org/en/jsr/detail?id=316)
...
## Java EE 7: [JSR 342](https://jcp.org/en/jsr/detail?id=342)
...
* Web Application Technologies
    ...
    * JSR 367: Java API for JSON Binding 1.0
