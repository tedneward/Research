...
summary=Tools and reports and training, all around distributed system liveness.
~~~~~~

[Website](https://jepsen.io/) | [Source](https://github.com/jepsen-io)
...
[Distributed Systems class (Source)](https://github.com/aphyr/distsys-class) (Outline): *(This is a really good outline)*
...
- Adya 1999: Weak Consistency: A Generalized Theory and Optimistic
  ...
  - Isolation levels prevent these phemomena
    ...
    - SI: No g0, G1, G-single
      - It's a little more subtle than this, but we generally don't have time for G-nonadjacent
...
- But *malicious* attackers can *induce* concurrency
  ...
  - [Chase Bank's credit card rewards system](https://chadscira.com/post/5fa269d46142ac544e013d6e/DISCLOSURE-Unlimited-Chase-Ultimate-Rewards-Points)
    - Concurrent transfers between balances allowed the creation of $70,000 USD in travel vouchers.
    - Redeemable for cash!
...
- Martin Kleppmann's [Designing Data-Intensive Applications](https://dataintensive.net/) offers a thorough tour of distributed systems for practitioners.
