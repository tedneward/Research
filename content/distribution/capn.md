title=Cap'n Proto, Cap'n Web
tags=distribution, networking, rpc
summary=New RPC implementations.
~~~~~~

Cap'n Proto: [Website](https://capnproto.org/) | [Source](https://github.com/capnproto/capnproto)
...
When bandwidth really matters, you should apply general-purpose compression, like [zlib](http://www.zlib.net/) or [LZ4](https://github.com/Cyan4973/lz4), regardless of your encoding format.
...
Cap'n Web: [Source](https://github.com/cloudflare/capnweb)
