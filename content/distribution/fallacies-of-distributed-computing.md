...
I added a few before relocating them to [a separate fallacies list](/architecture/fallacies-of-enterprise-computing)

* The system is monolithic
* The system is finished
* Business logic can (and should) be centralized

There's a few places of reference and/or explanatory text around this.
...
# Other sources/explanations

- [Whitepaper](https://arnon.me/wp-content/uploads/Files/fallacies.pdf) - Arnon Rotem-Gal-Oz
