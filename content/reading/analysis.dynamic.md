title=Dynamic Program Analysis reading
...
- [Program Analysis](https://gist.github.com/MattPD/00573ee14bf85ccac6bed3c0678ddbef)
	- [Static Program Analysis](analysis.static.html) - static analysis (static checkers and compilers) and verification 
...
- [Dynamic Binary Instrumentation (DBI)](#dynamic-binary-instrumentation-dbi)
	- [Readings](#dynamic-binary-instrumentation-dbi-readings)
	- [Software](#dynamic-binary-instrumentation-dbi-software)
- [Dynamic Binary Translation (DBT)](#dynamic-binary-translation-dbt)
- [Software](#software):
	- [Frida](#software-frida)
	- [Pin](#software-pin)
		- [Readings](#software-pin-readings)
		- [Projects](#software-pin-projects)
	- [Sanitizers](#software-sanitizers)
		- [Readings](#software-sanitizers-readings)
			- [Research](#software-sanitizers-readings-research)
		- [Projects](#software-sanitizers-projects)
		- [Talks](#software-sanitizers-talks)
