...
[Website](https://www.purescript.org/) | [Source](https://github.com/purescript/purescript) | [Docs](https://pursuit.purescript.org/)| Purescript by Example, [https://book.purescript.org/](https://book.purescript.org/) ([Source](https://github.com/paf31/purescript-book))
...
## [Learn X in Y minutes Quick Intro](https://learnxinyminutes.com/docs/purescript/):
All the noncommented lines of code can be run in the PSCi REPL, though some will require "paste" mode (`:paste` followed by multiple lines, terminated by `^D`).
