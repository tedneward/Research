title=Uiua *(wee-wuh)*
tags=language, stack, array
summary=A general purpose, stack-based, array-oriented programming language with a focus on simplicity, beauty, and tacit code.
~~~~~~

[Website](https://www.uiua.org/) | [Source](https://github.com/uiua-lang/uiua)
...
Lots of symbols a-la languages like J and APL.
