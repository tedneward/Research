title=Jason
tags=language, logic
summary=A fully-fledged interpreter for an extended version of AgentSpeak, a BDI agent-oriented logic programming language.
~~~~~~

[Website](https://jason.sourceforge.net/wp/) | [Source](https://github.com/jason-lang/jason) | [AgentSpeak presentation (PDF)](http://www.cs.ox.ac.uk/people/michael.wooldridge/teaching/robotics/agentspeak)
...
* Python: [python-agentspeak](https://github.com/niklasf/python-agentspeak)
