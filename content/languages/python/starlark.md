title=Starlark (formerly Skylark)
tags=language, tool, python, dynamic
summary=A language intended for use as a configuration language, based on Python syntax.
~~~~~~
