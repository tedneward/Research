title=Assembly language (generic)
tags=language, assembly, native
summary=Collection of assembly language resources that don't fit in one of the other categories.
~~~~~~

[Wikipedia](https://en.wikipedia.org/wiki/Comparison_of_assemblers)

## Assemblers

* [HLA (High-level assembler)](../hla)
* [FASM (flat assembler)](../fasm)
* [GNU Assembler (as)](../as)
* [Keystone assembler framework](../keystone)
* [NASM (The Netwide Assembler)](../nasm)
* [Yasm](../yasm)

## Disassemblers

* [Capstone disassembly/disassembler framework](../capstone)
