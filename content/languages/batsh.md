title=Batsh
tags=language, tool, linux, macos, windows
summary=A language that cross-compiles to bash and Windows batch command-line shell-scripting languages.
~~~~~~

[https://batsh.org] | [Source](https://github.com/batsh-dev-team/Batsh)
