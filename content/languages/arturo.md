title=Arturo
tags=language, windows, macos, linux, vm
summary=A "no-syntax" language running on top of a bytecode-VM.
~~~~~~

[Website](https://arturo-lang.io/) | [Source](https://github.com/arturo-lang) | [Docs](https://arturo-lang.io/documentation/) | [Binaries](https://arturo-lang.io/#download)

Curl it: `curl -sSL https://get.arturo-lang.io | sh`

Homebrew: `brew install arturo`

Looks to be very Lisp- and Red/Rebol-inspired.

## [Learn Arturo in 15 Minutes](https://arturo-lang.io/documentation/in-a-nutshell/)
