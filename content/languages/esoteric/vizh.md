title=Vizh
tags=language, esoteric, graphic
summary=An esoteric visual language that takes image files as input based on a multi-tape turing machine, designed for compatibility with C.
~~~~~~
...
![Implementation of memcpy in vizh](https://github.com/TartanLlama/vizh/blob/main/images/memcopy.png)
...
![Image decorated with the instructions that are recognised](https://github.com/TartanLlama/vizh/blob/main/images/parser_output.png)
...
![Version of the memcopy program with some instructions changed](https://github.com/TartanLlama/vizh/blob/main/images/bad_memcopy.png)

Well you get the best compiler errors you'll ever see:

![The errors highlighted and explained](https://github.com/TartanLlama/vizh/blob/main/images/compiler_error.png)
