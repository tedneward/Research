...
summary=A logic/functional programming language which combines the clarity and expressiveness of declarative programming with advanced static analysis and error detection features. Influences from Prolog, ML, and Haskell.
~~~~~~

[Website](http://www.mercurylang.org/) | [Source](https://github.com/Mercury-Language) | [Tutorial](https://github.com/Mercury-Language/mercury/wiki/Tutorial)

* [Mercury Tutorial](https://mercurylang.org/documentation/papers/book.pdf) - a more traditional tutorial with a more relaxed pace
...
## [Learn X in Y minutes Quick Intro](https://learnxinyminutes.com/docs/mercury/)
