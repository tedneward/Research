...
Numerous languages seek to supplant or replace C as the ubiquitous system language. None so far have been successful beyond their communities.
...
* [Emscripten](https://emscripten.org/): C/C++ to Web Assembly
...
* [OpenWatcom](http://www.openwatcom.org/): Watcom C/C++ used to be a commercial compiler toolkit, now FOSS
...
# [modern-c-features](https://github.com/AnthonyCalandra/modern-c-features/blob/master/README.md)
