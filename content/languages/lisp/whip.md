title=Whip
tags=language, lisp
summary=Haskell-flavoured LISPish language thingy.
~~~~~~

[Source](http://github.com/L8D/whip) | [Docs (unpublished GitHub pages)](https://github.com/L8D/whip/tree/gh-pages/docs)

### [Learn X in Y minutes Quick Intro](https://learnxinyminutes.com/docs/whip/)

Whip is a LISP-dialect made for scripting and simplified concepts. It has also borrowed a lot of functions and syntax from Haskell.
