title=Jule
tags=language
summary=Simple and safe programming language with built-in concurrency, first-class C/C++ interoperability and powerful compile-time capabilities.
~~~~~~

[Website](https://jule.dev/) | [Source](https://github.com/julelang/jule) | [Manual](https://manual.jule.dev) | [Future of Jule](https://jule.dev/future-of-jule)
