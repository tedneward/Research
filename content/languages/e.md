title=E
tags=language, object, distribution, dynamic, jvm, object capability
summary=An object-oriented programming language for secure distributed computing.
~~~~~~

[Website](http://erights.org)

Two E language implementations: [E-on-Java](http://erights.org/download/index.html) and [E-on-CommonLisp](http://homepage.mac.com/kpreid/elang/e-on-cl/)

[E in a Walnut](http://wiki.erights.org/wiki/Walnut) | [The E Language](http://erights.org/elang/index.html) | [ELib](http://erights.org/elib/index.html) provides inter-object semantics on top of the JVM and might need to be its own entry
