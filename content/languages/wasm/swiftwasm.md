title=SwiftWasm
tags=language, wasm
summary=Write Swift, compile to WASM/WebAssembly bytecode.
~~~~~~

[Website](https://swiftwasm.org/) | [Source](https://github.com/swiftwasm/swift) | [The SwiftWasm Book](https://swiftwasm.github.io/swiftwasm-book) - The primary collaborative documentation project for SwiftWasm.
