...
tags=language, format, hardware
summary=A specialized language used to describe the structure/behavior of real world circuits. It is used by circuit designers to simulate circuits and logic prior to wiring and fabricating a hardware circuit.
~~~~~~
...
## [Learn X in Y minutes Quick intro](https://learnxinyminutes.com/docs/hdl/)
