...
summary=Small scripting language for the web. ("The underscore is silent.")
~~~~~~

[Website](https://hyperscript.org/) | [Source](https://github.com/bigskysoftware/_hyperscript)

Paired with [htmx](../presentation/htmlx)

Influenced by [HyperTalk](./hypertalk), the language of [HyperCard](../presentations/hypercard).
